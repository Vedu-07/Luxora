...
export const REVIEWS = {
  text: "Hear what our clients have to say about their experiences with L U X O R A. We take pride in our work and are committed to delivering top-notch home renovation services.",
  reviews: [
    {
      name: "Alice Johnson",
      title: "Homeowner",
...
export const CONTACT_INFO = {
  ...
  address: {
    label: "Address",
    value: "1234 Luxora Residence, Suite 100, Your City, ST 56789",
  },
};
